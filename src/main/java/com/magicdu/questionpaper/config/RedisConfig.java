 ...
 * @author magicdu
 * @date 2020-04-20
 * @lastupdate  duziqiang  互联网版本增加 redis  集群配置
 */
@Configuration
@EnableCaching
...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public RedisTemplate<Object, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        // 建议使用这种方式，小范围指定白名单
        ParserConfig.getGlobalInstance().addAccept("com.xyl.base.model");
        ParserConfig.getGlobalInstance().addAccept("com.xyl.base.auth.security");
